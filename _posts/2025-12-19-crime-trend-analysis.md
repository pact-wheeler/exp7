...
They cited this [FBI database](https://cde.ucr.cjis.gov/LATEST/webapp/#/pages/explorer/crime/query?utm_source=danielphayward.com) as a reference and combined both property and violent crime as their source. But violent crime and property crime are wildly different. It's a different experience for you to be held up at gun point and having your car stolen. There is also the problem of context. Most people couldn't tell you why crimes are per 100,000 population or if 250 violent crimes per 100,000 people is a lot or not very much. A single data point just doesn't really tell you much of anything without context.
